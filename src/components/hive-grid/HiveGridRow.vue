<template>
  ...
  >
    ...
    >
      <template #edit="{ value, update, isChangeAllowed, toggle, customChange }">
        <slot
...
import HiveGridCeil from '@/ui-kit/src/components/hive-grid/HiveGridCeil.vue';
...
import useEventHandler, { type EventConfig } from '@/ui-kit/src/common/hooks/base/use-event-handler';
