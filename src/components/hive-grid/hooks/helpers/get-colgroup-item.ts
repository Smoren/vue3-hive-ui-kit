import COLUMN_WIDTH from '@/ui-kit/src/components/hive-grid/constants';
import type { ColgroupItem, ColumnWithChildren, ColumnWithoutChildren } from '@/ui-kit/src/components/hive-grid/types';
